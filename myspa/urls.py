...
from myspa.views import (AdminMainPage, BlogNewsView, CafeTypeProductListView, CafeView, DeleteProcedureView, DeleteSpaCategoriesView, DeleteTherapistView, DeleteTypeCategoriesView, GalleryView, GetReviews, MainPage, RecordView, Register, TypeBlogNewsViewListView, TypeCategoriesListView, TypeGalleryListView, get_therapist_schedule)
